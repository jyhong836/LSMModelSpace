function [trained_esn,stateCollection] = train_esn(trainInput, trainOutput , esn, nForgetPoints,val)
...
switch trained_esn.learningMode
    case 'offline_singleTimeSeries'
        ...
        [stateCollection,internalState] = compute_statematrix(trainInput, trainOutput, trained_esn, nForgetPoints) ; 
        teacherCollection = compute_teacher(trainOutput, trained_esn, nForgetPoints) ;             
        trained_esn.outputWeights = feval(trained_esn.methodWeightCompute, stateCollection, teacherCollection,val) ;
