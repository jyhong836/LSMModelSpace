function [outputSequence y]= test_esn(inputSequence, esn, nForgetPoints, varargin)
...
%xlswrite('Xxtrain',stateCollection);

% j=1;
% for k=1:1799
% for i=1:50
%     x(j,1)=stateCollection(k,i);
%     j=j+1;
% end
% end
% y=30;
% hist(x,y);
%x=stateCollection(:,1:end-2);
%x=flipud(stateCollection);
